...
namespace RandToe
{
    public class MacroBoard
    {
        ...
        /// <summary>
        /// Creates a new board and set the round
        /// </summary>
        /// <param name="round"></param>
        /// <param name="fields"></param>
        /// <returns></returns>
        public static MacroBoard CreateNewBoard(int round)
        {
            return new MacroBoard(round);
        }
        ...
        public static void AddMacroboardData(MacroBoard board, sbyte[] macroboard)
        {
            ...
            if (board.Slots != null && board.MacroBoardStates != null)
            {
        ...
        /// <param name="board"></param>
        /// <param name="macroboard"></param>
        public static void AddFieldData(MacroBoard board, sbyte[] fieldData)
        {
            // Set the data
            board.SetSlots(fieldData);
        ...
        /// Set slots
        /// </summary>
        private void SetSlots(sbyte[] fieldData)
        {
            // Set the slots
            Slots = new sbyte[9][];
            int count = 0;
